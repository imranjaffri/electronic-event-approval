...
public class AddUserActivity extends AppCompatActivity implements PostAPIRequest.ResponseHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sign_in_again.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent signInAgaintIntent = new Intent(AddUserActivity.this, LoginActivity.class);
        ...
        register_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (user_email.equals("") && user_password.equals("") && user_comfirm_password.equals("")) {
                    ...
                    AppController.showSnackBar(AddUserActivity.this, signUpLayout, "Please Enter the Credentials");

                } else if (user_email.equals("") && !user_password.equals("") && !user_comfirm_password.equals("")) {

                    AppController.showSnackBar(AddUserActivity.this, signUpLayout, "please Enter a Email");

                } else if (user_password.equals("") && user_comfirm_password.equals("") && !user_email.matches(emailPattern)) {

                    AppController.showSnackBar(AddUserActivity.this, signUpLayout, "Please Enter a Valid Email");
                    ...
                    AppController.showSnackBar(AddUserActivity.this, signUpLayout, "please Enter the Password");
                    ...
                    AppController.showSnackBar(AddUserActivity.this, signUpLayout, "please Enter Confirm Password");

                } else if (!user_email.equals("") && !user_password.equals("") && !user_comfirm_password.matches(user_password)) {

                    AppController.showSnackBar(AddUserActivity.this, signUpLayout, "Password does not matches");

                } else if (!user_email.matches(emailPattern)) {
                    AppController.showSnackBar(AddUserActivity.this, signUpLayout, "Not Valid Email");
                } else {
                    ...
                    new PostAPIRequest(AddUserActivity.this, url, map, new PostAPIRequest.ResponseHandler() {
                        @Override
                        public void onResponse(String response) {
                            Toast.makeText(getApplicationContext(), "You have successfully Register a new member", Toast.LENGTH_LONG).show();
                        ...
                        public void onError(String error) {
                            AppController.showSnackBar(AddUserActivity.this, signUpLayout, error);
                        }
                    }).initiate();
                }
            }
